import { requestRouteWebToken, getTokenPreview } from './routeWebServer';
...
/**
 * Checa se as variáveis SHIFT_* de autenticação estão configuradas.
 * Se sim, usa credenciais próprias para gerar o token da Shift API.
 * Se não, faz fallback para o token da Route Web.
 */
...
export { requestRouteWebToken as requestShiftToken, getTokenPreview };

export async function getShiftToken(): Promise<string> {
